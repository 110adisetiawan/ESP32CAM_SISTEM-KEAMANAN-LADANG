                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="card shadow">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">! Data Pergerakan Terakhir !</h6>
                                ...
                                <div class="container" id="List">
                                    <div class="row">
                                        <content>
                                            <?php
                                            $i = 1;
                                            $rows = mysqli_query($conn, "SELECT * FROM alarm ORDER BY ID DESC LIMIT 1");
                                            foreach ($rows as $row) :
                                            ?>
                                                <div class="col mb-3">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                <!-- Card Header - Dropdown -->
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Riwayat Pergerakan</h6>
